...
file mal-formed due to ignoring the waypoint uniqueness constraint takes ~140 ms.

Running through the entire provided test suite takes ~50 ms with the Python implementation and ~4 ms with the C++
implementation.
